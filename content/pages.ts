  ...
  [
    {
      ...
      breadcrumb: "Home", updatedOn: "2026-09-12", index: true, sitemap: { changeFrequency: "weekly", priority: 1 },
      localizable: true,
    },
    {
      ...
      breadcrumb: "Jobs", updatedOn: "2026-09-12", index: true, sitemap: { changeFrequency: "daily", priority: 0.9 },
      localizable: true,
    },
    {
      ...
      breadcrumb: "Apply", updatedOn: "2026-09-12", index: true, sitemap: { changeFrequency: "monthly", priority: 0.5 },
      localizable: true,
    },
    {
      ...
      breadcrumb: "Job seekers", updatedOn: "2026-09-12", index: true, sitemap: { changeFrequency: "monthly", priority: 0.7 },
      localizable: true,
    },
    {
      ...
      breadcrumb: "Employers", updatedOn: "2026-09-12", index: true, sitemap: { changeFrequency: "monthly", priority: 0.7 },
      localizable: true,
    },
    {
      ...
      breadcrumb: "Services", updatedOn: "2026-09-12", index: true, sitemap: { changeFrequency: "monthly", priority: 0.6 },
      localizable: true,
    },
    {
      ...
      breadcrumb: "About", updatedOn: "2026-09-12", index: true, sitemap: { changeFrequency: "monthly", priority: 0.6 },
      localizable: true,
    },
    {
      ...
      breadcrumb: "Contact", updatedOn: "2026-09-12", index: true, sitemap: { changeFrequency: "monthly", priority: 0.5 },
      localizable: true,
    },
    {
