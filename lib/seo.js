    ...
    "@graph": [
      {
        ...
        // The company's legal founding date, per the MCA record. The site's
        // "since 2008" copy describes the business's industry EXPERIENCE and is
        // deliberately not asserted here — foundingDate on an Organization node
        // that also carries legalName and taxID must match the company register.
        foundingDate: LEGAL_ENTITY.incorporationISO,
        sameAs: SAME_AS,
