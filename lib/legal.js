 ...
 * address WITHOUT the record's care-of line — a private individual's name — or
 * the premises number that belongs to it. `careOf` and `premises` stay here so
 * the record remains complete for filings and cross-checks, but nothing public
 * reads them: every page, the structured data, llms.txt and the emails use
 * `lines` (through ADDRESS_LINES / ADDRESS_ONE_LINE). content/content.test.ts
 * fails if either reaches a public string.
 */
export const REGISTERED_ADDRESS = {
  /** Part of the MCA record. Never displayed. */
  careOf: "C/o Asha Yadav",
  /** Part of the MCA record. Not displayed (it belongs to the care-of line). */
  premises: "G No-364",
  street: "Mishrapur Kursi Road",
  area: "Jankipuram",
  /** The public street lines. */
  lines: ["Mishrapur Kursi Road, Jankipuram"],
  locality: "Lucknow",
  district: "Lucknow",
...
//             "genuine, screened opportunities" statements removed.
