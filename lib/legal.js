...
//     rather than guessed — no emigration/recruiting-agent licence number is
//     recorded because none has been supplied.
...
/**
 * Registered office exactly as recorded at the MCA. This is the address of
 * record for the company and the one a counterparty or regulator will
 * cross-check, so it is what the legal pages publish.
 */
...
export const POLICY_EFFECTIVE_DATE = "6 September 2026";
export const POLICY_EFFECTIVE_ISO = "2026-09-06";
