...
/**
 * @param {{ jobTitle: string, jobCountry?: string, fullName: string, email: string, phone: string,
 *   experience?: string, message?: string, pageSource: string, cvFile: File, passportFile: File,
 *   otherFiles?: File[] }} application
