...
// The third-party list below is prefaced "There are no others", so it has to be
// exactly right. On this branch email goes only through Resend (lib/email/*, via the
// /api/forms/* routes); EmailJS has been removed from the code. This page must
