...
export const metadata = pageMetadata({
  ...
  path: "/pricing",
  description:
    "How Go Gulf charges for its recruitment services: who pays, what a service fee covers, what is a third-party cost, and why every fee is quoted in writing before you pay.",
});
